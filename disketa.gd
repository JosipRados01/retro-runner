...
func start_hover_animation():
	...
	# Animate up and down with slight variation for each collectible
	var hover_distance = 8.0  # How far up/down to move
	var hover_duration = 2.0  # Duration for one complete cycle
...
func _on_body_entered(body):
	...
	if body.name == "player":
		...
		print("Disketa collected! +", POINTS, " points")
